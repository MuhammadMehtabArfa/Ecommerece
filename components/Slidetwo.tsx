...
const Slidetwo: React.FC<Props> = ({ image, id }) => {
  return (
    <Link href={`/product_detail/${id}`}>
      <div className="rounded-xl border-[1px] border-gray-600 w-full  flex-col gap-5 ml-4 mt-3">
        {" "}
        ...
        <div className="flex flex-col mt-3 pl-3 gap-1">
          ...
          <div className=" flex gap-2">
            ...
            <span className="text-dull text-sm md:text-base lg:text-base">
              4.4
            </span>
            <ADStarOutlined className=" size-[14px] my-auto" />
          </div>
          <div className="flex gap-4 pb-3">
            <h1 className=" font-libre text-xs md:text-sm  ">RS 700</h1>
