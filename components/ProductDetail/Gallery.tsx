      ...
      <div className="mt-4 py-1 mx-4 border-2 grid grid-cols-1 md:grid-cols-2 ">
        ...
        <div className=" flex w-full flex-col bg-white rounded-lg  p-5">
          <div className="flex justify-between">
            <h3 className="text-xl font-medium">Women's Denim Jacket (Blue)</h3>
          ...
          <div className="flex justify-between mt-4">
            ...
            <div className="text-red-500 line-through">Rs. 1000 (30% off)</div>
          </div>
          <div className="flex  mt-4">
            <div className="appearance-none">
              <select className="border rounded-md px-2  py-1  appearance-none">
                <option> Size </option>
                <option>S</option>
                <option>M</option>
                <option>L</option>
          ...
          <button className="bg-blue block w-[120px] rounded-md mx-auto mt-4 font-bold text-lg  text-white ">
            Add to Cart
          </button>
        </div>
      </div>
        ...
        <div className="flex justify-between">
          <button
            className={`text-blue underline ${
              isActive === "details" && "bg-blue text-white"
            } font-bold hover:bg-blue hover:text-white text-lg justify-between px-2`}
          ...
          <button
            className={`text-blue underline ${
              isActive === "specification" && "bg-blue text-white"
            } font-bold hover:bg-blue hover:text-white text-lg justify-between px-2`}
          ...
          <button
            className={`text-blue underline ${
              isActive === "rating" && "bg-blue text-white"
            } font-bold hover:bg-blue hover:text-white text-lg justify-between px-2`}
